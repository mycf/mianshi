...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"seed": 5668,
			"version": 32,
			"versionNonce": 1445017198,
			"updated": 1704283353059,
			"isDeleted": false,
			"groupIds": [],
			"boundElements": [
				{
		...
		},
		{
			...
			"seed": 951087278,
			"version": 29,
			"versionNonce": 1588784174,
			"isDeleted": false,
			"boundElements": null,
			"updated": 1704283351115,
			"link": null,
			"locked": false,
			"text": "等待进入synchonised",
			"rawText": "等待进入synchonised",
			"fontSize": 16,
			"fontFamily": 3,
			"textAlign": "center",
			"verticalAlign": "middle",
			"baseline": 15,
			"containerId": "W4QOScCM",
			"originalText": "等待进入synchonised",
			"lineHeight": 1.2
		},
		{
			"points": [
